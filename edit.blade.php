    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            ...
            <form method="POST" action="/task/{{ $task->id }}">
                ...
                <div class="form-group">
                    <button type="submit" name="update" style="background: #f44336;    color: #fff;    display: block;    padding: 20px 10px;    text-align: center;   text-decoration: none;width: 100%;border-radius: 8px; // the rounded corners are here">Update task</button>
                </div>
            {{ csrf_field() }}
            </form>
        </div>
